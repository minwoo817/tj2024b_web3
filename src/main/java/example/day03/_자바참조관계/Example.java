...
public class Example {
    public static void main(String[] args) {
        ...
        // 7. reply 객체에서 board 객체 와 category 객체 알 수 있다? [O] , fk 이용하여 pk join
        // 7. category 객체에서 board 객체 와 reply 객체 알 수 있다? [X]
        ...
        // * StackOverflowError 오류 발생 : (JVM[Stack]의 메모리가 닫혔다.)
        // -> toString() 메소드 때문에 순환참조가 된다
        // category(ToString 포함) <---> boardList(String 포함)
